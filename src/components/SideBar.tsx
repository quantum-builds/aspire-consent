...
//   console.log("set menu status is ", menuStatus);

//   return (
//     <div
//       className={` bg-[#5353FF] w-full min-h-screen px-6 py-8 lg:flex flex-col z-50 sticky top-0 overflow-y-auto  transform ${
...
//     >
//       {/* Logo */}
//       {menuStatus !== undefined && setMenuStatus !== undefined && (
//         <Image
//           className="absolute right-12 top-14 cursor-pointer items-end"
//           src={LeftArrow}
//           alt="Close Menu"
//           width={60}
//           height={40}
...
//   return (
//     <div
//       className={`bg-[#5353FF] w-64 h-full px-6 py-8 flex flex-col z-50 overflow-y-auto transform ${
//         menuStatus !== undefined
//           ? menuStatus
//             ? "translate-x-0"
//             : "-translate-x-full"
...
//       {/* Practice Selector */}
//       {/* <div className="mb-6"> */}
//       {/* ... existing practice selector code ... */}
//       {/* </div> */}
